 ...
 * The below solution is not as fancy as supporting logger injection or eventing, but I really wanted
 * to get logging working quickly while I was working on protocol integrations.
 *
