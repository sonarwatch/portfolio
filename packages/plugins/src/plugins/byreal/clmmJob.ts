...
import { byrealClmmPid, byrealPlatformId as platformId } from './constants';
import {
  ParsedAccount,
  TokenAccount,
  tokenAccountStruct,
...
import { PoolState, poolStateStruct } from '../raydium/structs/clmms';
import { clmmPoolsStateFilter } from '../raydium/filters';
...
const executor: JobExecutor = async (cache: Cache) => {
  ...
  const allPoolsPubkeys = await client.getProgramAccounts(byrealClmmPid, {
